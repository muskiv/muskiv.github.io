...
// let q = 'someemail@gmail.com';
// let w ='someeMAIL@gmail.com';
// let e ='someeMAIL@i.ua';
// let r ='some.email@gmail.com';
...
//         if(email.includes('@') || array1[0] === '' || array[0].includes('.') || array1[0].length <= 2){
...
// }
// let str = "Сила тяжести приложена к центру масс тела";
// document.write(cutString(str, 5));